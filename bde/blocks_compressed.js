...
Blockly.Blocks.advanced_tone = {
    ...
    init: function() {
        this.setColour(150);
        this.appendDummyInput().appendField(Blockly.Msg.TonePin).appendField(new Blockly.FieldDropdown([
            ["3", "3"],
            ["5", "5"],
            ["6", "6"],
            ["9", "9"],
        ...
        this.appendValueInput("NUM", "Number").appendField(Blockly.Msg.Frequence).setCheck("Number");
...
Blockly.Blocks.advanced_tonedure = {
    ...
    init: function() {
        ...
        this.appendValueInput("NUM", "Number").appendField(Blockly.Msg.Frequence).setCheck("Number");
        this.appendValueInput("DUR", "Number").appendField(Blockly.Msg.Duration).setCheck("Number");
        this.setInputsInline(!0);
...
Blockly.Blocks.advanced_notone = {
    ...
    init: function() {
        this.setColour(150);
        this.appendDummyInput().appendField(Blockly.Msg.NoTonePin).appendField(new Blockly.FieldDropdown([
            ["3", "3"],
            ["5", "5"],
            ["6", "6"],
            ["9", "9"],
...
Blockly.Blocks.advanced_pulsein = {
    ...
    init: function() {
        this.setColour(150);
        this.appendDummyInput().appendField(Blockly.Msg.PulseIn).appendField(new Blockly.FieldDropdown(profile["default"].digital), "PIN").appendField(Blockly.Msg.INOUT_STAT).appendField(new Blockly.FieldDropdown([
...
Blockly.Blocks.conversion_tochar = {
    init: function() {
        ...
        this.appendValueInput("NAME").appendField(Blockly.Msg.CONV_tochar);
        this.setPreviousStatement(!0);
...
Blockly.Blocks.divers = {};
Blockly.Blocks.grove_temporature_sensor = {
    helpUrl: "http://www.seeedstudio.com/wiki/Project_Seven_-_Temperature",
    init: function() {
        this.setColour(150);
        this.appendDummyInput().appendField(Blockly.Msg.VAR_TemSens).appendField(new Blockly.FieldImage("http://www.seeedstudio.com/wiki/images/thumb/b/b0/Temperature1.jpg/400px-Temperature1.jpg", 64, 64)).appendField(Blockly.Msg.PIN).appendField(new Blockly.FieldDropdown(profile["default"].analog), "PIN");
        this.setOutput(!0, "Number");
...
Blockly.Blocks.grove_ultrasonic_ranger = {
    ...
    init: function() {
        this.setColour(150);
        this.appendDummyInput().appendField(Blockly.Msg.ultrasonic_ranger).appendField(new Blockly.FieldImage("http://www.seeedstudio.com/wiki/images/thumb/b/b0/Twig_-_Ultrasonic_Ranger2.jpg/200px-Twig_-_Ultrasonic_Ranger2.jpg", 64, 64)).appendField(Blockly.Msg.TRIG).appendField(new Blockly.FieldDropdown(profile["default"].digital_2), "PIN_TRIG").appendField(Blockly.Msg.Echo).appendField(new Blockly.FieldDropdown(profile["default"].digital_2),
            "PIN_ECHO");
        this.setOutput(!0, "Number");
...
Blockly.Blocks.grove_motor_shield = {
    ...
    init: function() {
        this.setColour(150);
        this.appendDummyInput().appendField(Blockly.Msg.VAR_Motor).appendField(new Blockly.FieldImage("http://www.seeedstudio.com/wiki/images/thumb/4/4d/Smotoshield2.jpg/400px-Smotoshield2.jpg", 64, 64)).appendField(new Blockly.FieldDropdown([
...
Blockly.Blocks.base_delayms = {
    ...
    init: function() {
        this.setColour(150);
        this.appendValueInput("DELAY_TIME", "Number").appendField(Blockly.Msg.DelayMs).setCheck("Number");
        this.setInputsInline(!0);
        this.setPreviousStatement(!0, null);
        this.setNextStatement(!0, null);
...
Blockly.Blocks.millis = {
    ...
    init: function() {
        this.setColour(150);
        this.appendDummyInput().appendField(Blockly.Msg.SinceProgramStarted);
        this.setOutput(!0, "Number");
...
Blockly.Blocks.var_random = {
    init: function() {
        this.setColour(150);
        this.setHelpUrl("");
        this.appendValueInput("rand_min").setCheck("Number").appendField(Blockly.Msg.RandomBetween);
        this.appendValueInput("rand_max").setCheck("Number").appendField(Blockly.Msg.And);
        this.setInputsInline(!0);
        this.setOutput(!0);
        this.setTooltip("")
    }
...
Blockly.Blocks.various_constrain = {
    init: function() {
        ...
        this.appendDummyInput().appendField(Blockly.Msg.Constrain);
        this.appendValueInput("x").setCheck("Number").appendField(Blockly.Msg.Number);
        this.appendValueInput("a").setCheck("Number").appendField(Blockly.Msg.NumberA);
        this.appendValueInput("b").setCheck("Number").appendField(Blockly.Msg.NumberB);
        this.setInputsInline(!0);
        this.setOutput(!0, "Number");
        this.setTooltip("Constrains a number to be within a range. ")
    }
};
Blockly.Blocks.inout = {};
...
Blockly.Blocks.inout_digital_read = {
    ...
    init: function() {
        this.setColour(30);
        this.appendDummyInput().appendField(Blockly.Msg.INOUT_DIG_READ).appendField(new Blockly.FieldDropdown(profile["default"].digital), "PIN");
        this.setOutput(!0, "Number");
...
Blockly.Blocks.inout_analog_read = {
    ...
    init: function() {
        this.setColour(30);
        this.appendDummyInput().appendField(Blockly.Msg.INOUT_ANA_READ).appendField(new Blockly.FieldDropdown(profile["default"].analog), "PIN");
        this.setOutput(!0, "Number");
...
Blockly.Blocks.inout_analog_write = {
    init: function() {
        this.setHelpUrl("");
        this.setColour(30);
        this.appendDummyInput().appendField(Blockly.Msg.INOUT_ANA_WRITE);
        this.appendDummyInput().appendField(new Blockly.FieldDropdown([
            ["3", "3"],
            ["5", "5"],
            ["6", "6"],
        ...
        this.appendValueInput("Value").setCheck("Number").appendField(Blockly.Msg.INOUT_VALUE);
        this.setInputsInline(!0);
        this.setPreviousStatement(!0);
        this.setNextStatement(!0);
        this.setTooltip("")
...
Blockly.Blocks.inout_buildin_led = {
    ...
    init: function() {
        this.setColour(30);
        this.appendDummyInput().appendField(Blockly.Msg.INOUT_BUI_LED).appendField(new Blockly.FieldDropdown([
            [Blockly.Msg.INOUT_HIGH_LEVEL, "HIGH"],
            [Blockly.Msg.INOUT_LOW_LEVEL, "LOW"]
        ]), "STAT");
        this.setPreviousStatement(!0, null);
...
Blockly.Blocks.inout_digital_write = {
    ...
    init: function() {
        this.setColour(30);
        this.appendDummyInput().appendField(Blockly.Msg.INPOUT_DIGITAL_WRITE).appendField(new Blockly.FieldDropdown(profile["default"].digital), "PIN").appendField(Blockly.Msg.INOUT_STAT).appendField(new Blockly.FieldDropdown([
            [Blockly.Msg.INOUT_HIGH_LEVEL, "HIGH"],
            [Blockly.Msg.INOUT_LOW_LEVEL, "LOW"]
        ]), "STAT");
        this.setPreviousStatement(!0, null);
...
Blockly.Blocks.while_do = {
    init: function() {
        this.setColour(190);
        this.setHelpUrl("http://www.example.com/");
        this.appendStatementInput("STATNAME").appendField(Blockly.Msg.CONTROLS_REPEAT_INPUT_DO);
        this.appendValueInput("CONDI").setCheck("Boolean").appendField(Blockly.Msg.CONTROLS_WHILEUNTIL_OPERATOR_WHILE);
        this.setPreviousStatement(!0);
        this.setNextStatement(!0);
        this.setTooltip("")
    }
...
Blockly.Blocks.cont_break = {
    init: function() {
        this.setColour(190);
        this.setHelpUrl("http://www.example.com/");
        this.appendDummyInput().appendField(Blockly.Msg.Break);
        this.setPreviousStatement(!0);
        this.setNextStatement(!0);
        this.setTooltip("")
    }
...
Blockly.Blocks.cont_continue = {
    init: function() {
        ...
        this.appendDummyInput().appendField(Blockly.Msg["continue"]);
        this.setPreviousStatement(!0);
        this.setNextStatement(!0);
        this.setTooltip("")
    }
...
Blockly.Blocks.cont_returnnull = {
    init: function() {
        ...
        this.appendDummyInput().appendField(Blockly.Msg.returnnull);
        this.setPreviousStatement(!0);
        this.setNextStatement(!0);
        this.setTooltip("")
    }
...
Blockly.Blocks.base_map = {
    ...
    init: function() {
        this.setColour(230);
        this.appendValueInput("NUM", "Number").appendField(Blockly.Msg.Math_map).setCheck("Number");
        this.appendValueInput("DMAX", "Number").appendField(Blockly.Msg.Math_valueto).setCheck("Number");
...
Blockly.Blocks.procedures_defnoreturn = {
    ...
    mutationToDom: function() {
        for (var a = document.createElement("mutation"), b = 0; b < this.arguments_.length; b++) {
            ...
            c.setAttribute("vartype", this.argumentstype_[x]);
            a.appendChild(c)
        }
    ...
    domToMutation: function(a) {
        this.arguments_ = [];
        this.argumentstype_ = [];
        for (var b = 0, c; c = a.childNodes[b]; b++) "arg" == c.nodeName.toLowerCase() && (this.arguments_.push(c.getAttribute("name")), this.argumentstype_.push(c.getAttribute("vartype")));
        this.updateParams_();
        this.setStatements_("false" !== a.getAttribute("statements"))
    },
    decompose: function(a) {
        var b =
            Blockly.Block.obtain(a, "procedures_mutatorcontainer");
        b.initSvg();
        ...
        for (var c = b.getInput("STACK").connection, d = 0; d < this.arguments_.length; d++) {
            ...
            e.setFieldValue(this.argumentstype_[d], "TYPEVAR");
            e.oldLocation = d;
            c.connect(e.previousConnection);
            c = e.nextConnection
        }
    ...
    compose: function(a) {
        ...
        this.paramIds_ = [];
        this.argumentstype_ = [];
        for (var b = a.getInputTargetBlock("STACK"); b;) this.arguments_.push(b.getFieldValue("NAME")), this.argumentstype_.push(b.getFieldValue("TYPEVAR")), this.paramIds_.push(b.id), b = b.nextConnection && b.nextConnection.targetBlock();
        this.updateParams_();
        Blockly.Procedures.mutateCallers(this.getFieldValue("NAME"), this.workspace, this.arguments_, this.paramIds_, this.argumentstype_);
        a = a.getFieldValue("STATEMENTS");
        if (null !== a && (a = "TRUE" == a, this.hasStatements_ != a))
            if (a) this.setStatements_(!0), a = this.getInput("STACK").connection, a.targetConnection || !this.statementConnection_ || this.statementConnection_.targetConnection || this.statementConnection_.sourceBlock_.workspace != this.workspace ? this.statementConnection_ = null : a.connect(this.statementConnection_);
            else {
    ...
    renameVar: function(a, b) {
        ...
        if (c && (this.updateParams_(), this.mutator.isVisible()))
            for (var c =
                    this.mutator.workspace_.getAllBlocks(), d = 0, e; e = c[d]; d++) "procedures_mutatorarg" == e.type && Blockly.Names.equals(a, e.getFieldValue("NAME")) && e.setFieldValue(b, "NAME")
    },
    customContextMenu: function(a) {
        var b = {
                enabled: !0
...
Blockly.Blocks.procedures_defreturn = {
    init: function() {
        ...
        this.appendValueInput("RETURN").setAlign(Blockly.ALIGN_RIGHT).appendField(Blockly.Msg.PROCEDURES_DEFRETURN_RETURN).appendField(Blockly.Msg.Var_As).appendTitle(new Blockly.FieldDropdown([
            ["long",
                "long"
            ],
            ["float", "float"],
...
Blockly.Blocks.procedures_mutatorarg = {
    init: function() {
        this.setColour(Blockly.Blocks.procedures.HUE);
        this.appendDummyInput().appendField(Blockly.Msg.PROCEDURES_MUTATORARG_TITLE).appendTitle(new Blockly.FieldDropdown([
            ["long", "long"],
            ["float", "float"],
            ["String", "String"],
            ["byte", "byte"],
            ...
            ["int", "int"],
            ["char", "char"]
        ]), "TYPEVAR").appendField(new Blockly.FieldTextInput("x", this.validator_), "NAME");
        this.setPreviousStatement(!0);
        this.setNextStatement(!0);
...
Blockly.Blocks.serial_printfor = {
    ...
    init: function() {
        this.setColour(20);
        this.setInputsInline(!0);
        this.appendValueInput("CONTENT", "Number").setCheck("Number").appendTitle(Blockly.Msg.Serial_Print_Format).appendTitle(new Blockly.FieldDropdown([
...
Blockly.Blocks.serial_read = {
    ...
    init: function() {
        this.setColour(20);
        this.appendDummyInput("").appendTitle(Blockly.Msg.Serial_read);
        this.setInputsInline(!0);
        this.setOutput(!0, "Number");
...
Blockly.Blocks.serial_available = {
    ...
    init: function() {
        this.setColour(20);
        this.appendDummyInput("").appendTitle(Blockly.Msg.Serial_avai);
        this.setInputsInline(!0);
        this.setOutput(!0, "Number");
...
Blockly.Blocks.serial_print = {
    ...
    init: function() {
        this.setColour(20);
        this.appendValueInput("CONTENT", "String").appendField(Blockly.Msg.Serial_Print);
        this.setPreviousStatement(!0, null);
        this.setNextStatement(!0, null);
...
Blockly.Blocks.serial_write = {
    ...
    init: function() {
        this.setColour(20);
        this.appendValueInput("CONTENT", String).appendTitle(Blockly.Msg.Serial_Write);
        this.setPreviousStatement(!0, null);
        this.setNextStatement(!0, null);
...
Blockly.Blocks.serial_write_out = {
    ...
    init: function() {
        ...
        this.setColour(20);
        this.appendValueInput("valeur").appendField(Blockly.Msg.Serial_write_out);
        this.setInputsInline(!0);
        this.setOutput(!0, "Number");
        this.setTooltip("Writes binary data to the serial port. This data is sent as a byte or series of bytes; to send the characters representing the digits of a number use the print() function instead.")
    }
...
Blockly.Blocks.serial_flush = {
    ...
    init: function() {
        this.setColour(20);
        this.appendDummyInput("").appendTitle(Blockly.Msg.Serial_flush);
        this.setPreviousStatement(!0, null);
        this.setNextStatement(!0, null);
...
Blockly.Blocks.serial_printL = {
    ...
    init: function() {
        this.setColour(20);
        this.appendValueInput("CONTENT", "String").appendField(Blockly.Msg.Serial_PrintL);
        this.setPreviousStatement(!0, null);
        this.setNextStatement(!0, null);
        this.setTooltip("Prints data to the console/serial port as human-readable ASCII text.")
    }
};
Blockly.Blocks.seriallcd = {};
Blockly.Blocks.grove_serial_lcd_print = {
    ...
    init: function() {
        this.setColour(120);
        this.appendDummyInput().appendField(Blockly.Msg.LCD_Serial).appendField(Blockly.Msg.PIN).appendField(new Blockly.FieldDropdown(profile["default"].digital), "PIN");
        this.appendValueInput("TEXT", "String").setCheck("String").setAlign(Blockly.ALIGN_RIGHT).appendField(Blockly.Msg.LCD_Print_Line1);
        this.appendValueInput("TEXT2", "String").setCheck("String").setAlign(Blockly.ALIGN_RIGHT).appendField(Blockly.Msg.LCD_Print_Line2);
        this.appendValueInput("DELAY_TIME", "Number").setCheck("Number").setAlign(Blockly.ALIGN_RIGHT).appendField(Blockly.Msg.Delay);
        this.setPreviousStatement(!0, null);
        this.setNextStatement(!0, null);
...
Blockly.Blocks.grove_serial_lcd_power = {
    ...
    init: function() {
        this.setColour(120);
        this.appendDummyInput().appendField(Blockly.Msg.LCD_Serial).appendField(Blockly.Msg.PIN).appendField(new Blockly.FieldDropdown(profile["default"].digital), "PIN");
        this.appendDummyInput().setAlign(Blockly.ALIGN_RIGHT).appendField(Blockly.Msg.Power).appendField(new Blockly.FieldDropdown([
                [Blockly.Msg.ONN, "ON"],
...
Blockly.Blocks.grove_serial_lcd_effect = {
    ...
    init: function() {
        this.setColour(120);
        this.appendDummyInput().appendField(Blockly.Msg.LCD_Serial).appendField(Blockly.Msg.PIN).appendField(new Blockly.FieldDropdown(profile["default"].digital), "PIN");
        this.appendDummyInput().setAlign(Blockly.ALIGN_RIGHT).appendField(Blockly.Msg.LCD_Effect).appendField(new Blockly.FieldDropdown([
            [Blockly.Msg.LCD_Scroll_Left, "LEFT"],
            [Blockly.Msg.LCD_Scroll_Right,
                "RIGHT"
            ],
...
Blockly.Blocks.servo_move = {
    ...
    init: function() {
        this.setColour(80);
        this.appendDummyInput().appendField(Blockly.Msg.SERVO_Servo).appendField(new Blockly.FieldImage("http://www.seeedstudio.com/depot/images/product/a991.jpg", 64, 64)).appendField(Blockly.Msg.PIN).appendField(new Blockly.FieldDropdown(profile["default"].digital), "PIN");
        this.appendValueInput("DEGREE", "Number").setCheck("Number").setAlign(Blockly.ALIGN_RIGHT).appendField(Blockly.Msg.Degree);
        this.appendValueInput("DELAY_TIME",
            "Number").setCheck("Number").setAlign(Blockly.ALIGN_RIGHT).appendField(Blockly.Msg.Delay);
        this.setPreviousStatement(!0, null);
        this.setNextStatement(!0, null);
...
Blockly.Blocks.servo_read_degrees = {
    ...
    init: function() {
        this.setColour(80);
        this.appendDummyInput().appendField(Blockly.Msg.SERVO_Servo).appendField(new Blockly.FieldImage("http://www.seeedstudio.com/depot/images/product/a991.jpg", 64, 64)).appendField(Blockly.Msg.PIN).appendField(new Blockly.FieldDropdown(profile["default"].digital), "PIN");
        this.appendDummyInput().appendField(Blockly.Msg.SERVO_ReadDegree);
        this.setOutput(!0, "Number");
...
Blockly.Blocks.servo_attached = {
    ...
    init: function() {
        this.setColour(80);
        this.appendDummyInput().appendField(Blockly.Msg.SERVO_Attached).appendField(new Blockly.FieldImage("http://www.seeedstudio.com/depot/images/product/a991.jpg", 64, 64)).appendField(Blockly.Msg.PIN).appendField(new Blockly.FieldDropdown(profile["default"].digital), "PIN");
        this.setOutput(!0, "Boolean");
...
Blockly.Blocks.servo_detach = {
    ...
    init: function() {
        this.setColour(80);
        this.setInputsInline(!0);
        this.appendDummyInput().appendField(Blockly.Msg.SERVO_Detach).appendField(new Blockly.FieldDropdown(profile["default"].digital), "PIN");
        this.setPreviousStatement(!0, null);
        this.setNextStatement(!0, null);
...
Blockly.Blocks.soft_init = {
    ...
    init: function() {
        this.setColour(50);
        this.appendDummyInput().appendField(Blockly.Msg.SSERIAL_Init).appendField(Blockly.Msg.SSERIAL_TX).appendField(new Blockly.FieldDropdown([
            ["2", "2"],
            ["3", "3"],
            ["4", "4"],
            ["5", "5"],
        ...
        this.appendDummyInput().appendField(Blockly.Msg.SSERIAL_RX).appendField(new Blockly.FieldDropdown([
            ["2", "2"],
            ["3",
                "3"
            ],
...
Blockly.Blocks.soft_read = {
    ...
    init: function() {
        this.setColour(50);
        this.appendDummyInput("").appendTitle(Blockly.Msg.SSERIAL_Read);
        this.setInputsInline(!0);
...
Blockly.Blocks.soft_available = {
    ...
    init: function() {
        this.setColour(50);
        this.appendDummyInput("").appendTitle(Blockly.Msg.SSERIAL_Avai);
        this.setInputsInline(!0);
        this.setOutput(!0, "Boolean");
        this.setTooltip("")
    }
...
Blockly.Blocks.string_declare = {
    ...
    init: function() {
        ...
        this.appendValueInput("VALUE", null).appendField(Blockly.Msg.Var_Declare).appendField(new Blockly.FieldString(Blockly.LANG_VARIABLES_SET_ITEM), "VAR").appendField(Blockly.Msg.String_As).appendField(Blockly.Msg.INOUT_VALUE);
        this.setPreviousStatement(!0);
        this.setNextStatement(!0);
        this.setTooltip("")
    },
...
Blockly.Blocks.string_get = {
    init: function() {
        ...
        this.setColour(Blockly.Blocks.string.HUE);
        this.appendDummyInput().appendField(new Blockly.FieldString(Blockly.Msg.VARIABLES_DEFAULT_NAME), "VAR");
        this.setOutput(!0);
...
Blockly.Blocks.string_charat = {
    init: function() {
        ...
        this.setColour(Blockly.Blocks.string.HUE);
        this.appendDummyInput().appendField(new Blockly.FieldString(Blockly.Msg.VARIABLES_DEFAULT_NAME), "VAR");
        this.appendValueInput("NAME").setCheck("Number").appendField(Blockly.Msg.STRING_charat2);
        this.setInputsInline(!0);
        this.setOutput(!0, "string");
        this.setTooltip(Blockly.Msg.VARIABLES_GET_TOOLTIP);
        this.contextMenuMsg_ = Blockly.Msg.VARIABLES_GET_CREATE_SET
...
Blockly.Blocks.string_compareto = {
    init: function() {
        this.setColour(Blockly.Blocks.string.HUE);
        this.appendDummyInput().appendField(new Blockly.FieldString(Blockly.Msg.VARIABLES_DEFAULT_NAME), "VAR");
        this.appendValueInput("input_to_compare").setAlign(Blockly.ALIGN_CENTRE).appendField(Blockly.Msg.STRING_compareTo);
        this.setInputsInline(!0);
        this.setOutput(!0, "Number");
        this.setTooltip("");
...
Blockly.Blocks.string_concat = {
    init: function() {
        this.setColour(Blockly.Blocks.string.HUE);
        this.appendDummyInput().appendField(new Blockly.FieldString(Blockly.Msg.VARIABLES_DEFAULT_NAME), "VAR");
        this.appendValueInput("NAME").appendField(Blockly.Msg.STRING_Contact);
        this.setPreviousStatement(!0);
        this.setNextStatement(!0);
        this.setTooltip("");
        this.setInputsInline(!0);
...
Blockly.Blocks.string_lengthof = {
    init: function() {
        this.setColour(Blockly.Blocks.string.HUE);
        this.appendDummyInput().appendField(Blockly.Msg.STRING_LengthOf);
        this.appendDummyInput().appendField(new Blockly.FieldString(Blockly.Msg.VARIABLES_DEFAULT_NAME), "VAR");
        this.setInputsInline(!0);
        this.setOutput(!0, "Number");
        this.setTooltip("");
...
Blockly.Blocks.string_endswith = {
    init: function() {
        this.setColour(Blockly.Blocks.string.HUE);
        this.appendDummyInput().appendField(new Blockly.FieldString(Blockly.Msg.VARIABLES_DEFAULT_NAME), "VAR");
        this.appendValueInput("input_to_compare").setAlign(Blockly.ALIGN_CENTRE).appendField(Blockly.Msg.STRING_Ends_With);
        this.setInputsInline(!0);
        this.setOutput(!0, "Boolean");
        this.setTooltip("");
...
Blockly.Blocks.string_equalto = {
    init: function() {
        this.setColour(Blockly.Blocks.string.HUE);
        this.appendDummyInput().appendField(new Blockly.FieldString(Blockly.Msg.VARIABLES_DEFAULT_NAME), "VAR");
        this.appendValueInput("input_to_compare").setAlign(Blockly.ALIGN_CENTRE).appendField(Blockly.Msg.STRING_Equal);
        this.setInputsInline(!0);
        this.setOutput(!0, "Boolean");
        this.setTooltip("");
        this.setHelpUrl("https://www.arduino.cc/en/Reference/StringCompareTo")
...
Blockly.Blocks.text_char = {
    ...
    newQuote_: function(a) {
        return new Blockly.FieldImage(Blockly.pathToMedia + (a == Blockly.RTL ?
            "quote1.png" : "quote0.png"), 12, 12, '"')
    }
};
...
Blockly.Blocks.variables_declare = {
    ...
    init: function() {
        ...
        this.appendValueInput("VALUE", null).appendField(Blockly.Msg.Var_Declare).appendField(new Blockly.FieldVariable(Blockly.LANG_VARIABLES_SET_ITEM), "VAR").appendField(Blockly.Msg.Var_As).appendTitle(new Blockly.FieldDropdown([
            ["long", "long"],
            ["float", "float"],
            ["String", "String"],
            ["byte", "byte"],
            ...
            ["int", "int"],
            ["char", "char"]
        ]), "TYPE").appendField(Blockly.Msg.INOUT_VALUE);
        this.setPreviousStatement(!0);
        this.setNextStatement(!0);
        this.setTooltip("")
    },
