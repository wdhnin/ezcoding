...
//IN OUT
Blockly.Msg.INOUT_HIGH_LEVEL = "مرتفع";
Blockly.Msg.INOUT_LOW_LEVEL = "منخفض";
Blockly.Msg.INPOUT_DIGITAL_WRITE = "الكتابة الرقمية على المدخل ";
Blockly.Msg.INOUT_STAT = "الوضع";
Blockly.Msg.INOUT_DIG_READ = "الفراءة الرقمية على المدخل";
Blockly.Msg.INOUT_ANA_READ = "القراءة التماثلية على المدخل";
Blockly.Msg.INOUT_BUI_LED = "وضع الصمام الداخلي";
Blockly.Msg.INOUT_ANA_WRITE = "الكتابة الرقمية";
Blockly.Msg.INOUT_VALUE = "القيمة";


//SERIAL
Blockly.Msg.Serial_Print = "نسخ سطر جديد ";
Blockly.Msg.Serial_PrintL = "نسخ على نفس السطر";
Blockly.Msg.Serial_Write = "التسلسل كتابة";
Blockly.Msg.Serial_write_out = "كتابة";
Blockly.Msg.Serial_Print_Format = "النسخ بشكل";
...
Blockly.Msg.Serial_read = "التسلسل القراءة";
Blockly.Msg.Serial_avai = "التسلسل متوفر؟";
Blockly.Msg.Serial_flush = "التسلسل إنتظار نهاية الإرسال";

//SOFTWARE SERIAL
Blockly.Msg.SSERIAL_Init = "التهيئة";
Blockly.Msg.SSERIAL_TX = "TX# الارسال";
Blockly.Msg.SSERIAL_RX = "RX# الاستقبال";
Blockly.Msg.SSERIAL_Read = "التسلسل البرمجي القراءة";
Blockly.Msg.SSERIAL_Print = "التسلسل البرمجي النسخ";
Blockly.Msg.SSERIAL_Write = "التسلسل البرمجي كتابة";
Blockly.Msg.SSERIAL_Avai = "التسلسل البرمجي متوفر؟";

//SERVO
Blockly.Msg.SERVO_Servo = "المحركات";
Blockly.Msg.PIN = "#المدخل";
Blockly.Msg.Degree = "(0~180)الدرجة";
Blockly.Msg.Delay = "التوقيت";
Blockly.Msg.SERVO_ReadDegree = "قراءة الدرجات";
Blockly.Msg.SERVO_Attached = "المحرك موصول؟";
Blockly.Msg.SERVO_Detach = "فصل المحرك من المدخل ";

//SERIAL LCD
Blockly.Msg.LCD_Serial = "شاشة العرض التسلسلي";
Blockly.Msg.LCD_Print_Line1 = "كتابة على السطرالأول ";
Blockly.Msg.LCD_Print_Line2 = "كتابة على السطر الثاني";
Blockly.Msg.Power = "الطاقة";
Blockly.Msg.ONN = "التشغيل";
Blockly.Msg.OFFF = "التوقف";
Blockly.Msg.LCD_Effect = "الكيفية";
Blockly.Msg.LCD_Scroll_Left = "التحرك في اتجاه اليسار";
Blockly.Msg.LCD_Scroll_Right = "التحرك في اتجاه اليمين";
Blockly.Msg.LCD_Scroll_Auto = "التحرك التلقائي";

//LCD PARALLEL
Blockly.Msg.LCDP_Setup = "إعداد شاشة العرض التسلسلي";
Blockly.Msg.LCDP_RS = "إعادة تعيين";
Blockly.Msg.LCDP_Enabled = "تشغيل";
Blockly.Msg.LCDP_D4 = "4 المعطيات";
Blockly.Msg.LCDP_D5 = "5 المعطيات";
Blockly.Msg.LCDP_D6 = "6 المعطيات";
Blockly.Msg.LCDP_D7 = "7 المعطيات";
Blockly.Msg.LCDP_Column = "عمود";
Blockly.Msg.LCDP_Row = "سطر";
Blockly.Msg.LCDP_Print = "نسخ شاشة العرض التسلسلي";
Blockly.Msg.LCDP_Clear = "فسخ شاشة العرض التسلسلي ";
Blockly.Msg.LCDP_scrollDisplayLeft = "مرر النص لليسار ";
Blockly.Msg.LCDP_scrollDisplayRight = "مرر النص لليمين ";
Blockly.Msg.LCDP_Home = "بداية  شاشة العرض التسلسلي ";
Blockly.Msg.LCDP_SetCursor = "وضع المؤشر";
Blockly.Msg.LCDP_Display = "أعرض شاشة العرض التسلسلي ";
Blockly.Msg.LCDP_noDiplay = "لا تعرض شاشة العرض التسلسلي";
Blockly.Msg.LCD_I2C_setup = "العنوان(I2C)    إعداد شاشة العرض التسلسل ";

//VARIOUS
Blockly.Msg.VAR_TemSens = "مجس الحرارة";
Blockly.Msg.VAR_Motor = "محرك";
Blockly.Msg.Stop = "توقف";
Blockly.Msg.Forward = "امام";
Blockly.Msg.Right = "يمين";
Blockly.Msg.Left = "يسار";
Blockly.Msg.Backward = "الخلف";
Blockly.Msg.DelayMs = "مهلة جزء من الثانية";
Blockly.Msg.SinceProgramStarted = "منذ انطلاق البرنامج";
Blockly.Msg.RandomBetween = "عدد عشوائي بين";
Blockly.Msg.And = "و";
Blockly.Msg.Constrain = "احصر";
Blockly.Msg.Number = "العدد";
Blockly.Msg.NumberA = "أ";
Blockly.Msg.NumberB = "ب";
Blockly.Msg.PulseIn = "إنتظار التغيير";
Blockly.Msg.ultrasonic_ranger = "مجس الموجات فوق الصوتية";
Blockly.Msg.unit = "الوحدة";
Blockly.Msg.cm = "سنتيمتر";
Blockly.Msg.inch = "بوصة";
Blockly.Msg.TRIG = "TRIG ارسال";
Blockly.Msg.Echo = "Echo صدى صوت";


//LOOPS
Blockly.Msg.Break = "كسر";
Blockly.Msg.continue = "واصل";
Blockly.Msg.returnnull = "ARReturn";


//VARIABLES 
Blockly.Msg.Var_Declare = "أعلن";
Blockly.Msg.Var_As = "ك";

//Math "Map "
Blockly.Msg.Math_map = "تحويل";
Blockly.Msg.Math_valueto = "- 0 إل المجال";

//STRING SET
Blockly.Msg.STRING_SET = "ضع في %1 قيمة %2";
Blockly.Msg.STRING_SET_CREATE_GET = "ARCreate String 'get %1'";
Blockly.Msg.STRING_SET_HELPURL = "https://github.com/google/blockly/wiki/Variables#set";
Blockly.Msg.STRING_SET_TOOLTIP = "ARSets this string to be equal to the input.";
Blockly.Msg.RENAME_VARIABLE = "ARRename variable...";
Blockly.Msg.String_As = "كسلسلة حروف";
Blockly.Msg.STRING_charat = "ضع في %1 قيمة %2";
Blockly.Msg.STRING_charat2 = "حرف بالموضع ";
Blockly.Msg.STRING_compareTo = "مقارنة مع ";
Blockly.Msg.STRING_Contact = "دمج ";
Blockly.Msg.STRING_LengthOf = "طول ";
Blockly.Msg.STRING_Ends_With = "ينتهي ب";
Blockly.Msg.STRING_Equal = "مساوي ل";


//Conversions
Blockly.Msg.CONV_tochar = "Char تحوييل إلى";
Blockly.Msg.CONV_tobyte = "Byte تحوييل إلى";
Blockly.Msg.CONV_toint = "Int تحوييل إلى";
Blockly.Msg.CONV_tofloat = "Float تحوييل إلى";

//ADVANCED IO
Blockly.Msg.TonePin = "#نغمة المدخل";
Blockly.Msg.Frequence = "تردد";
Blockly.Msg.Duration = "المدة";
Blockly.Msg.NoTonePin = "#إلغاء نغمة المدخل";
Blockly.Msg.Setup = "الإعداد";
Blockly.Msg.Loop = "الحلقة الرئيسية";

Blockly.Msg.sup = "اكبر >";
Blockly.Msg.supeg = "اكبرأو يساوي \u2265";
Blockly.Msg.inf = "اصغر <";
Blockly.Msg.infeg = "اصغرأو يساوي \u2264";
