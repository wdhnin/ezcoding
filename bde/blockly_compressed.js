        ...
        if (e = a[g], "string" == typeof e) d.push([e, void 0]);
            ...
            do switch (h = !1, e.type) {
                ...
                case "field_variable":
                    ...
                    break;
                case "field_string":
                    f = new Blockly.FieldString(e.string);
                    break;
                case "field_dropdown":
...
Blockly.FieldAngle.prototype.updateGraph_ = function() {
    if (this.gauge_) {
        var a = goog.math.toRadians(+this.getText());
...
Blockly.Variables.flyoutCategory = function(a) {
    ...
    if (Blockly.Blocks.variables_declare) {
        ...
        c.setAttribute("type", "variables_declare");
        b.push(c)
    }
    for (var d = 1; d < a.length; d++) {
        if (Blockly.Blocks.variables_set) {
            ...
            var e = goog.dom.createDom("field", null, a[d]);
            e.setAttribute("name", "VAR");
            c.appendChild(e);
            b.push(c)
        }
        Blockly.Blocks.variables_get && (c = goog.dom.createDom("block"), c.setAttribute("type", "variables_get"), Blockly.Blocks.variables_set && c.setAttribute("gap", 24), e = goog.dom.createDom("field", null, a[d]), e.setAttribute("name", "VAR"), c.appendChild(e), b.push(c))
    }
    return b
};
...
Blockly.String.allString = function(a) {
    var b;
    if (a.getDescendants) b = a.getDescendants();
    else if (a.getAllBlocks) b = a.getAllBlocks();
    else throw "Not Block or Workspace: " + a;
    ...
    for (var c = 0; c < b.length; c++)
        if (b[c].getString)
            for (var d = b[c].getString(), e = 0; e < d.length; e++) {
                var f = d[e];
                f && (a[f.toLowerCase()] = f)
            }
    b = [];
...
Blockly.String.renameString = function(a, b, c) {
    c = c.getAllBlocks();
    for (var d = 0; d < c.length; d++) c[d].renameString && c[d].renameString(a, b)
};
Blockly.String.flyoutCategory = function(a) {
    a = Blockly.String.allString(a);
    a.sort(goog.string.caseInsensitiveCompare);
    goog.array.remove(a, Blockly.Msg.VARIABLES_DEFAULT_NAME);
    a.unshift(Blockly.Msg.VARIABLES_DEFAULT_NAME);
    var b = [];
    if (Blockly.Blocks.string_declare) {
        var c = goog.dom.createDom("block");
        c.setAttribute("type", "string_declare");
        b.push(c)
    }
    for (var d = 1; d < a.length; d++) {
        if (Blockly.Blocks.string_set) {
            c = goog.dom.createDom("block");
            c.setAttribute("type", "string_set");
            Blockly.Blocks.string_get && c.setAttribute("gap",
                8);
            var e = goog.dom.createDom("field", null, a[d]);
            e.setAttribute("name", "VAR");
            c.appendChild(e);
        ...
        Blockly.Blocks.string_get && (c = goog.dom.createDom("block"), c.setAttribute("type", "string_get"), Blockly.Blocks.string_set && c.setAttribute("gap", 24), e = goog.dom.createDom("field", null, a[d]), e.setAttribute("name", "VAR"), c.appendChild(e), b.push(c));
        Blockly.Blocks.string_charat && (c = goog.dom.createDom("block"), c.setAttribute("type", "string_charat"), Blockly.Blocks.string_charat && c.setAttribute("gap", 24),
            e = goog.dom.createDom("field", null, a[d]), e.setAttribute("name", "VAR"), c.appendChild(e), b.push(c));
        Blockly.Blocks.string_compareto && (c = goog.dom.createDom("block"), c.setAttribute("type", "string_compareto"), Blockly.Blocks.string_compareto && c.setAttribute("gap", 24), e = goog.dom.createDom("field", null, a[d]), e.setAttribute("name", "VAR"), c.appendChild(e), b.push(c));
        Blockly.Blocks.string_concat && (c = goog.dom.createDom("block"), c.setAttribute("type", "string_concat"), Blockly.Blocks.string_concat && c.setAttribute("gap",
            24), e = goog.dom.createDom("field", null, a[d]), e.setAttribute("name", "VAR"), c.appendChild(e), b.push(c));
        Blockly.Blocks.string_lengthof && (c = goog.dom.createDom("block"), c.setAttribute("type", "string_lengthof"), Blockly.Blocks.string_lengthof && c.setAttribute("gap", 24), e = goog.dom.createDom("field", null, a[d]), e.setAttribute("name", "VAR"), c.appendChild(e), b.push(c));
        Blockly.Blocks.string_endswith && (c = goog.dom.createDom("block"), c.setAttribute("type", "string_endswith"), Blockly.Blocks.string_endswith && c.setAttribute("gap",
            24), e = goog.dom.createDom("field", null, a[d]), e.setAttribute("name", "VAR"), c.appendChild(e), b.push(c));
        Blockly.Blocks.string_equalto && (c = goog.dom.createDom("block"), c.setAttribute("type", "string_equalto"), Blockly.Blocks.string_equalto && c.setAttribute("gap", 24), e = goog.dom.createDom("field", null, a[d]), e.setAttribute("name", "VAR"), c.appendChild(e), b.push(c))
    }
    return b
};
Blockly.String.generateUniqueName = function(a) {
    a = Blockly.String.allString(a);
    var b = "";
    if (a.length)
        for (var c = 1, d = 0, e = "ijkmnopqrstuvwxyzabcdefgh".charAt(d); !b;) {
...
Blockly.FieldString = function(a, b) {
    Blockly.FieldString.superClass_.constructor.call(this, Blockly.FieldString.dropdownCreate, null);
    this.setChangeHandler(b);
    this.setValue(a || "")
};
goog.inherits(Blockly.FieldString, Blockly.FieldDropdown);
Blockly.FieldString.prototype.setChangeHandler = function(a) {
    Blockly.FieldString.superClass_.setChangeHandler.call(this, a ? function(b) {
        var c = a.call(this, b);
        if (null === c) var d = c;
        else void 0 === c && (c = b), d = Blockly.FieldString.dropdownChange.call(this, c), void 0 !== d && (d = c);
        return d === b ? void 0 : d
    } : Blockly.FieldString.dropdownChange)
};
Blockly.FieldString.prototype.init = function(a) {
    this.sourceBlock_ || (this.getValue() || this.setValue(Blockly.String.generateUniqueName(a.isInFlyout ? a.workspace.targetWorkspace : a.workspace)), Blockly.FieldString.superClass_.init.call(this, a))
};
Blockly.FieldString.prototype.getValue = function() {
    return this.getText()
};
Blockly.FieldString.prototype.setValue = function(a) {
    this.value_ = a;
    this.setText(a)
};
Blockly.FieldString.dropdownCreate = function() {
    var a = this.sourceBlock_ && this.sourceBlock_.workspace ? Blockly.String.allString(this.sourceBlock_.workspace) : [],
        b = this.getText();
    b && -1 == a.indexOf(b) && a.push(b);
    a.sort(goog.string.caseInsensitiveCompare);
    a.push(Blockly.Msg.RENAME_VARIABLE);
...
Blockly.FieldString.dropdownChange = function(a) {
    function b(a, b) {
        Blockly.hideChaff();
        var c = window.prompt(a, b);
        c && (c = c.replace(/[\s\xa0]+/g, " ").replace(/^ | $/g, ""), c == Blockly.Msg.RENAME_VARIABLE || c == Blockly.Msg.NEW_VARIABLE) && (c = null);
    ...
    if (a == Blockly.Msg.RENAME_VARIABLE) {
        var d = this.getText();
        (a = b(Blockly.Msg.RENAME_VARIABLE_TITLE.replace("%1", d), d)) && Blockly.String.renameString(d, a, c);
        return null
    }
    if (a == Blockly.Msg.NEW_VARIABLE) return (a = b(Blockly.Msg.NEW_VARIABLE_TITLE,
        "")) ? (Blockly.String.renameString(a, a, c), a) : null
};
...
Blockly.Generator.prototype.getUnconnectedBlock = function() {
    for (var a = Blockly.mainWorkspace.getAllBlocks(), b = 0, c; c = a[b]; b++)
        for (var d = c.getConnections_(!0), e = 0, f; f = d[e]; e++)
            if (!f.sourceBlock_ || (f.type == Blockly.INPUT_VALUE || f.type == Blockly.OUTPUT_VALUE) && !f.targetConnection) return c;
    return null
};
Blockly.Generator.prototype.getBlockWithWarning = function() {
    for (var a = Blockly.mainWorkspace.getAllBlocks(), b = 0, c; c = a[b]; b++)
        if (c.warning) return c;
    return null
};
...
Blockly.Procedures.mutateCallers = function(a, b, c, d, e) {
    a = Blockly.Procedures.getCallers(a, b);
    for (b = 0; b < a.length; b++) a[b].setProcedureParameters(c, d, e)
};
...
Blockly.Flyout.prototype.show = function(a) {
    ...
    a == Blockly.Variables.NAME_TYPE ? a = Blockly.Variables.flyoutCategory(this.workspace_.targetWorkspace) : a == Blockly.Procedures.NAME_TYPE ? a = Blockly.Procedures.flyoutCategory(this.workspace_.targetWorkspace) : a == Blockly.String.NAME_TYPE && (a = Blockly.String.flyoutCategory(this.workspace_.targetWorkspace));
    var f = this.CORNER_RADIUS;
    this.svgGroup_.style.display = "block";
    for (var b = [], g = [], c = 0; e = a[c]; c++) e.tagName && "BLOCK" == e.tagName.toUpperCase() && (d = Blockly.Xml.domToBlock(this.workspace_, e), b.push(d), d = parseInt(e.getAttribute("gap"), 10), g.push(d || 3 * f));
    a = f;
    for (c = 0; d = b[c]; c++) {
        e = d.getDescendants();
