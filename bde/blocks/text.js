...
Blockly.Blocks['text_char'] = {
     ...
     */
    init: function() {
        this.setHelpUrl('http://arduino.cc/en/Reference/char');
        this.setColour(Blockly.Blocks.texts.HUE);
        this.appendDummyInput()
            //       .appendField(this.newQuote_(true))
            .appendField('\'')
            ...
            .appendField('\'')
        this.setOutput(true, 'String');
        this.setTooltip('A data type that takes up 1 byte of memory that stores a character value. Character literals are written in single quotes.');
    },
    /**
     * Create an image of an open or closed quote.
     * @param {boolean} open True if open quote, false if closed.
